...
class Login extends JFrame
{
	...
	forgetpass.setBounds(85,280,150,30);

	back = new JButton("Back");
	back.setBounds(120,330,80,30);

	ButtonHandler bh = new ButtonHandler();
	back.addActionListener(bh);
	forgetpass.addActionListener(bh);
			...
			if(ae.getSource()==login)
			{
				...
				try
				{
					...
					else if(rs.next())
					{
						...
						ResultSet rs1 = st1.executeQuery("select password from admreg where uid = '"+uname+"';");
						if(rs1.next())
						{
